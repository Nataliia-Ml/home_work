...
names_1 = ["John", "Kathy", "Oliver", "Daniel", "Anna", "Scott", "Adam"]
names_2 = ["Adam", "Jack", "Daniel", "Steven", "Oliver"]
for i in names_2:
    if i in names_1:
        print(f"Элемент со второго списка {i} есть в первом списке.")
    else:
        print(f"Элемента со второго списка {i} нет в первом списке.")
...
names_8 = ["Jack", "John", "Oliver", "Jack", "Daniel", "Scott", "John", "Steven", "Adam"]
for name in names_8:
    if int(names_8.count(name)) > 1:
        print(f"Повторяющийся элемент: {name}.")
